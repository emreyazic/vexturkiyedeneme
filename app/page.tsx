        ...
        <footer className="relative bg-[#0f172a] border-t border-gray-800 text-gray-300">
          <div className="container mx-auto px-6 max-w-7xl py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
              ...
              <div>
                <h3 className="text-red-400 font-bold mb-6 text-lg tracking-wide uppercase">RECF PROGRAMLARI</h3>
              ...
              <div>
                <h3 className="text-red-400 font-bold mb-6 text-lg tracking-wide uppercase">İLETİŞİM</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 text-xs text-gray-400 leading-relaxed">
              <p className="font-bold text-gray-300 mb-2">RECF – VEX Ayrım Bildirimi</p>
              <p>
