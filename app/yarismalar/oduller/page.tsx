...
const awards = [
    {
        ...
        description: 'Excellence Award, RECF robotik yarışmalarının en prestijli ödülüdür. Bu ödülü kazanan takım, mühendislik, performans ve takım çalışmasında gösterdiği üstün başarı ile öne çıkar.',
        highlights: [
            'RECF STEM World Championship adaylığı',
            'Global tanınırlık',
            'Prestijli başarı sertifikasyonu'
        ],
        criteria: [
